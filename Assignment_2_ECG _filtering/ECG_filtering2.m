...
subplot(5, 2, 1);
len1 = (length(signal2) -1 ) / Fs;
plot(0:T:len1, signal2);
set(gca,'XLim',[0 len1]);
xlabel("Time (s)");
...
comb = filter(b_comb, a_comb, signal2);
...
convoluted = filter(b_conv, a_conv, signal2);
